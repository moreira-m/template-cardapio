                        ...
                        {hasVegan && (
                            ...
                            >
                                <svg width="30" height="30" viewBox="0 0 65 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M5.91415 8.349C5.91415 8.349 -5.66513 28.716 3.58088 46.2728C12.827 63.8294 32.8901 54.4277 32.8901 54.4277C32.8901 54.4277 35.4298 58.6501 36.4017 62.6403C36.4512 62.8632 36.589 63.0565 36.7836 63.1759C36.9783 63.2955 37.2131 63.3309 37.4343 63.2742C37.4476 63.2734 37.4601 63.2702 37.4727 63.2671C37.8174 63.1789 38.0709 62.8859 38.1088 62.5324C37.6199 60.6589 34.5724 53.1032 15.6464 26.6727C15.6464 26.6727 26.1859 39.4786 34.2085 52.7528C34.2085 52.7528 42.3081 43.9315 34.9357 27.1774C27.5633 10.4231 5.91415 8.349 5.91415 8.349Z" className={`${styles.filterBtnIcon} ${styles.filled}`} strokeWidth="3" strokeMiterlimit="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path fillRule="evenodd" clipRule="evenodd" d="M28.6954 16.3993C39.4105 3.33427 59.1821 5.0146 59.1821 5.0146C59.1821 5.0146 66.9119 27.1284 54.6621 42.7431C49.282 49.6008 42.9014 51.0217 37.4367 50.4586C39.2459 46.6961 41.0636 39.7733 37.6292 29.8823C40.2388 27.242 43.1252 24.3846 46.3163 21.2967C46.3163 21.2967 42.5312 24.4963 37.4205 29.2956C37.0981 28.4098 36.7337 27.5007 36.3236 26.5686C34.4694 22.3534 31.7522 19.0243 28.6954 16.3993Z" className={`${styles.filterBtnIcon} ${styles.filled}`} strokeWidth="3" strokeMiterlimit="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </button>
                        )}
                    </div>
